          ...
          <Modal.Body>
            <div className="row">
              ...
              <div className="col-12 col-md-7 col-lg-6 col-xl-6">
                <h2>৭১৫ টাকা রিচারজে পাচ্ছেন</h2>
                <p>৬০ জিবি ইন্টারনেট</p>
                <p>১২০০ মিনিট(সকল অপারেটর)</p>
                <p>৩০ দিন মেয়াদ</p>
                <p>২০ পয়সা কলরেট সকল অপারেটর</p>
                <p>২০ পয়েন্টস</p>
                <div>
                  <button className="py-2 px-3 iconContainer1 border-0 text-light ">রিচারজ করুন</button>
                  <button className="py-2 px-3 iconContainer2 border-0 text-light ms-2">উপহার দিন</button>
                </div>
              </div>
            </div>
          </Modal.Body>
                ...
                {all && (
                  <div className="allContent text-center">
                      ...
                      <div onClick={handleShow} className="singleOffer">
                        ...
                        <div className="offerContent">
                          <div className="mt-1 d-flex align-items-center justify-content-between">
                            ...
                            <span className="border-0 py-0 px-2 rounded bg-primary text-light">
                              ৳ 715
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="text-center mt-5">
                      <button className="bg-primary text-light border-0 py-2 px-3 rounded">
                        View More
                      </button>
                    </div>
                  </div>
